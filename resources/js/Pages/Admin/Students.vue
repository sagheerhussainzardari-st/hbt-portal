        ...
        <div class="bg-white m-4   h-full p-6 rounded shadow ">
            ...
            <div class="">
                <table class="w-full border table">
                    ...
                    <tbody class="">
                        <tr v-for="(student,index) in students" class="odd:bg-gray-100 hover:odd:bg-gray-200 hover:even:bg-gray-200 transition duration-300 ">
                        ...
                        <tr v-if="students.length < 1" class="">
